...
- Manifest: `loadouts/media-video/loadout.yaml`
- Base: `default`
- Supported runtimes: `claude`

This page lists direct entries on `media-video`. Inherited entries come from `loadouts/default/SOURCES.md`.
...
- `media-video` — internal loadout pack; inspect `shared/packs/media-video/PACK.md`.
