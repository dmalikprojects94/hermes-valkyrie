...
- Manifest: `loadouts/writing-docs/loadout.yaml`
- Base: `default`
- Supported runtimes: `claude, codex`

This page lists direct entries on `writing-docs`. Inherited entries come from `loadouts/default/SOURCES.md`.

## Direct shared skills

- `verification-loop` — internal/legacy repo design
- `research-ops` — internal/legacy repo design
- `writing-docs` — internal/legacy repo design
...
- `writing-docs` — internal loadout pack; inspect `shared/packs/writing-docs/PACK.md`.
...
- `writing-docs` — Internal Hermes repo design or legacy Claude OpenClaw/OpenClaw-derived behavior; no external repo adoption recorded for this item.
