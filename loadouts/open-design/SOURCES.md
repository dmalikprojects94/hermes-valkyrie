...
- Manifest: `loadouts/open-design/loadout.yaml`
- Base: `frontend-design`
- Supported runtimes: `claude, codex`

This page lists direct entries on `open-design`. Inherited entries come from `loadouts/frontend-design/SOURCES.md`.
...
- `open-design` — internal loadout pack; inspect `shared/packs/open-design/PACK.md`.
