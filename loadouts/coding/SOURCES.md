...
- Manifest: `loadouts/coding/loadout.yaml`
- Base: `default`
- Supported runtimes: `claude, codex`

This page lists direct entries on `coding`. Inherited entries come from `loadouts/default/SOURCES.md`.
...
|---|---|---|---|
| `mattpocock/skills` | not recorded in the original 2026-05-28 report; upstream repo; exact license not recorded in current baseline report | `diagnose`, `prototype` | attribution recorded in this SOURCES.md |
