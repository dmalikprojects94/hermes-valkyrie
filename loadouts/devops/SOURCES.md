...
- Manifest: `loadouts/devops/loadout.yaml`
- Base: `default`
- Supported runtimes: `claude, codex`

This page lists direct entries on `devops`. Inherited entries come from `loadouts/default/SOURCES.md`.
...
- `devops` — internal loadout pack; inspect `shared/packs/devops/PACK.md`.
