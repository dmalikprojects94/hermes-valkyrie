# project-planner loadout sources
...
- Manifest: `loadouts/project-planner/loadout.yaml`
- Base: `default`
- Supported runtimes: `claude, codex`

This page lists direct entries on `project-planner`. Inherited entries come from `loadouts/default/SOURCES.md`.

## Direct shared skills

- `verification-loop` — internal/legacy repo design
- `grill-with-docs` — internal/legacy repo design
...
- `project-planner` — internal loadout pack; inspect `shared/packs/project-planner/PACK.md`.

## External sources used directly

| Source | Revision/license | Direct items | Evidence |
|---|---|---|---|
| `mattpocock/skills` | not recorded in the original 2026-05-28 report; upstream repo; exact license not recorded in current baseline report | `grill-me`, `to-issues`, `to-prd`, `triage` | attribution recorded in this SOURCES.md |
...
- `grill-with-docs` — Internal Hermes repo design or legacy Claude OpenClaw/OpenClaw-derived behavior; no external repo adoption recorded for this item.
