...
- Manifest: `loadouts/research/loadout.yaml`
- Base: `default`
- Supported runtimes: `claude, codex`

This page lists direct entries on `research`. Inherited entries come from `loadouts/default/SOURCES.md`.
...
- `research-posture` — internal/legacy repo design

## Direct packs

- `research` — internal loadout pack; inspect `shared/packs/research/PACK.md`.
...
- `research-posture` — Internal Hermes repo design or legacy Claude OpenClaw/OpenClaw-derived behavior; no external repo adoption recorded for this item.
